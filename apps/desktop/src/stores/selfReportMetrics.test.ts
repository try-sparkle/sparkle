  ...
  it("holds ONLY count keys — no identifying free-text ever lands in the store", () => {
    ...
    expect(Object.keys(s.controlOps).sort()).toEqual(
      [
        ...
        "concierge_tool",
        // The Chief tool spine. Same treatment and it matters MORE here: the payload names a real
        // client's project and the verb being run on it, and neither is stored — only that Chief
        // was reached.
        "chief_tool",
