        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              // cascade, so clamping only max-width leaves a 340px floor that can exceed a narrow
              // viewport. These two lines plus the right anchor ARE the containment — see the note
              // above the component for why the measured nudge that used to follow them is gone.
