...
export function buildAdvisorQuestion(args: AdvisorPassArgs): string {
  ...
  return [
    ...
    "   for each area the plan touches. Exit 10 = a REAL path intersection with an open PR; exit 12 =",
    "   a commit already on the base changes a file this plan changes; 11 = a shared name only, which",
    "   is NOT a collision. Report ONLY what a command actually printed, and cite the command.",
